import { ArrowRight, Cloud, Code2, Database, Github, Linkedin, Mail, ServerCog } from "lucide-react";
...
function Hero() {
  return (
    <section id="home" className="relative min-h-screen px-5 pt-28 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:py-24">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300 sm:text-xl">
            DataOps Engineer specializing in monitoring, automation, cloud technologies, and
          ...
          <div className="glass-panel relative rounded-3xl p-6 shadow-card">
            <div className="mb-6 flex items-center justify-between border-b border-line pb-5">
              <div>
                ...
                <p className="mt-1 text-xl font-bold text-white">Modern Web + DataOps</p>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {highlights.map(({ icon: Icon, label }) => (
                <div key={label} className="rounded-2xl border border-line bg-white/[0.03] p-5">
